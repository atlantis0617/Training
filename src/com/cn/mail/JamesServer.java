...
public class JamesServer {
	...
	public static void sendMail() {  
        ...
        String from = "yhy@yuanhuayang.com"; // 邮件发送人的邮件地址  
        String to = "yh@yuanhuayang.com"; // 邮件接收人的邮件地址  
        final String username = "yhy";  //发件人的邮件帐户  
        final String password = "yhy";   //发件人的邮件密码  
...
//            message.setText("From now, you have your own mail server, congratulation!");  
            message.setText("从现在开始我能配置我自己的邮件服务器了哈哈!");  
    ...
    public static void getMail(){  
        ...
        final String username = "yh";  
        final String password = "yh";  
